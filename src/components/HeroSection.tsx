              ...
              <div className="text-left max-w-lg">
               ...
               <p className="mt-4 text-lg text-gray-300">
                ...
                <div className="mt-6 flex space-x-4">
                  ...
                  <a href="#projects" className="border border-white text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 hover:bg-white hover:text-primary">
                    Learn More
                  </a>
                </div>
              </div>
