...
const Brands = () => {
  const brands = [
    ...
    {
      icon: <FaHeartbeat className="mr-2 text-xl" />,
      name: "Health Care",
      description:
    ...
    {
      icon: <FaCar className="mr-2 text-xl" />,
      name: "Automobiles",
      description:
