  ...
  return (
    <section className="relative bg-gradient-to-b from-[#EEF8FF] via-white to-white pt-32 md:pt-40 pb-20 md:pb-28 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[700px] h-[500px] bg-brand-navy/[0.06] rounded-full blur-[140px]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white border border-brand-navy/20 shadow-sm mb-8"
          >
          ...
          >
            ...
            <span className="bg-gradient-to-r from-[#0F6F94] via-brand-navy to-sky-500 bg-clip-text text-transparent">
              Phone Calls
            </span>{' '}
          ...
          >
            <a
              ...
              className="group inline-flex items-center justify-center gap-2 bg-gradient-to-r from-[#0F6F94] to-brand-navy hover:from-[#0c5977] hover:to-[#228cb2] text-white px-7 py-3.5 rounded-xl text-sm font-bold shadow-lg shadow-[#0F6F94]/20 transition-all duration-200 cursor-pointer"
            >
              Get a Free Demo
            ...
            <a
              href="#outcomes"
              className="inline-flex items-center justify-center gap-2 border border-slate-300 hover:border-brand-navy text-slate-700 bg-white hover:text-[#0F172A] px-7 py-3.5 rounded-xl text-sm font-semibold transition-all duration-200 shadow-sm hover:bg-slate-50 cursor-pointer"
            >
              See How It Works
            </a>
          </motion.div>
