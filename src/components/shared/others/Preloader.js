...
const Preloader = () => {
  return (
    <div className="preloader flex  h-screen w-full items-center justify-center  bg-whiteColor transition-all duration-700 ">
      {/* spinner  */}
      <div className="w-90px h-90px border-5px border-t-secondaryColor border-r-secondaryColor border-b-blue-light border-l-blue-light rounded-full animate-spin-infinit"></div>
