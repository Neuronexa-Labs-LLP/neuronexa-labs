...
const TestimonialsSection: React.FC = () => {
  ...
  return (
    <section ref={containerRef} className="py-16 md:py-20 bg-[#F4F9FC] relative flex items-center justify-center min-h-[50vh] overflow-hidden border-t border-slate-100">
      {/* Dynamic Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-brand-navy rounded-full blur-[250px] opacity-[0.08] pointer-events-none"></div>
      ...
      <div className="container mx-auto px-5 relative z-10 text-center max-w-5xl">
         <div className="flex justify-center mb-5">
           <motion.div
             ...
             viewport={{ once: true }}
             className="inline-flex items-center gap-2 bg-white/80 border border-brand-navy/20 text-[#0F172A] px-3.5 py-1.5 rounded-full text-xs font-bold shadow-sm"
           >
         ...
         <motion.div style={{ scale, opacity }}>
           ...
           <div className="flex flex-col items-center">
             <div className="w-14 h-14 rounded-full bg-gradient-to-br from-brand-navy to-[#1E3A5F] mb-4 p-[2px] shadow-md hover:scale-105 transition-transform duration-300">
             ...
             <p className="text-brand-navy uppercase tracking-widest text-xs font-bold mt-1">Founder, Vedims</p>
           </div>
         </motion.div>
      </div>
    </section>
