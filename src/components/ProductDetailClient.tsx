    ...
    <>
      ...
      <div className="relative pt-28 pb-16 lg:pt-36 lg:pb-24 overflow-hidden bg-slate-900 border-b border-slate-800">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-20">
              <Link href="/#projects" className="inline-flex items-center text-slate-400 hover:text-white transition-colors mb-6 group text-xs font-bold uppercase tracking-wider">
              ...
              <div className="lg:col-span-8 space-y-8">
                  ...
                  >
                      <div className="relative h-[250px] md:h-[400px] overflow-hidden">
                          <img src={project.image} alt={project.title} loading="lazy" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-102" />
                      </div>
                  </motion.div>
